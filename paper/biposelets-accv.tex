...
% TODO: Consider talk about downsampling and how it needs to be fixed. Only do
% this if I have space!
% Some of the underperformance of our model across all datasets could be
% explained by the way in which we produce heatmaps for each subpose and
% biposelet type.
