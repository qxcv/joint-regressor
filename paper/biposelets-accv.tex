...
of the context provided by surrounding frames. %TODO

Our contribution is %TODO
...
Keypoints (PCK) and Percentage Correct Parts (PCP)~\cite{yang2013articulated}.
...
evaluation code and models trained on FLIC in a similar manner to ours. PCK at
image scale is shown in Figure~\ref{fig:piw-pcks} and PCP is shown in
...
Combined~\cite{cherian2014mixing} and ~\cite{chen2014articulated} &
81.54\% & 96.97\% & 99.07\% & 79.79\% & 95.07\% & 98.58\%\\
Ours &
28.45\% & 63.25\% & 87.24\% & 70.53\% & 92.03\% & 96.97\%\\
\end{tabu}}\\
...
subject five, and had to settle for a randomly selected set of half the 120
...
given in Figure~\ref{fig:h36m-pck}.

\begin{figure*}[t]
\begin{center}
\input{figures/plots/h36m-pck.pgf}
\end{center}
\caption{Comparison of PCK for subject five on the Human3.6M dataset. Threshold
is normalised to the distance between the subject's left hip and right shoulder.}
\label{fig:h36m-pck}
\end{figure*}
