...
that our approach outperforms previous work on shoulder localisation, but that
localisation of wrists remains a challenge.
\end{abstract}
...
established pose estimation benchmarks. Our evaluation shows a significant
improvement in shoulder localisation accuracy compared to existing work, and
competitive performance on elbows, but lower performance on wrists. We posit
that this may be due to the granularity of the subposes we use and the way in
which we employ flow, and suggest several ways in which performance may be
improved as part of future work.
