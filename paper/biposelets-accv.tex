...
video at the same time. As an added bonus, this pairwise detection approach
gives rise to a relatively simple notion of temporal consistency of poses across
a video sequence, which is elucidated in Section~\ref{sec:stitching}.
...
the first stage stage discretises the space of configurations for joints within
...
results; code for the latter model was not publicly available at the time
...
evaluation. It should be noted that that the \textit{training} set of the pose
