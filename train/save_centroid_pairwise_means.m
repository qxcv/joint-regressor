function subpose_disps = save_centroid_pairwise_means(cache_dir, subpose_pa, shared_parts)
...
if ~exist(dest_path, 'file')
    ...
    subpose_disps = calc_subpose_disps(centroids, subpose_pa, shared_parts);
    save(dest_path, 'subpose_disps');
else
    subpose_disps = parload(dest_path, 'subpose_disps');
end
end